...
(() => {
  ...
  const chapters = {
    ...
    ,8:[
      ...
      ()=>matchStep({title:"8-3 産業を分類",prompt:"仕事を産業に分けよう。",rows:["農業","林業","水産業","鉱業","工業","建設業","商業","運輸通信業","サービス業"],answers:{"農業":"第一次産業","林業":"第一次産業","水産業":"第一次産業","鉱業":"第二次産業","工業":"第二次産業","建設業":"第二次産業","商業":"第三次産業","運輸通信業":"第三次産業","サービス業":"第三次産業"},success:"教材に出てくる産業分類をすべて確認しました。"}),
